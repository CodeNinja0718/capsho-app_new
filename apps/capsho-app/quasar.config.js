  ...
  return {
    ...
    build: {
      ...
      extendWebpack (cfg) {
        ...
        //     })
        //   )
        //   cfg.devtool = ctx.dev ? 'eval-cheap-module-source-map' : 'source-map'
        // }
      },
      chainWebpack (chain) {
    ...
    framework: {
      ...
      cssAddon: true, // flex breakpoint aware version for all spacing
    ...
    pwa: {
      ...
      manifest: {
        name: 'Capsho Beta App',
        short_name: 'Capsho Beta App',
        description: '',
        display: 'standalone',
