<template>
  ...
  >
    <q-card-section class="column items-center">
      <span class="text-center lexend-deca-bold letter-spacing-1 text-body2 text-uppercase text-plan-grey">{{ plan.role }}</span>
    ...
    <q-card-section class="text-center">
      <div class="row items-center justify-center q-gutter-x-xs no-wrap">
        <span class="text-h4 lexend-deca-regular text-weight-medium">{{ plan.price.perEpisode + ' ' }}</span>
