...
import CountdownOffer24 from 'components/CountdownOffer24.vue'
...
<template>
  <q-layout :view="getLayoutView('default')">
    <AppHeader v-if="!$route.meta.hideHeader"/>
    <q-page-container>
      <CountdownOffer24
        v-if="$route.meta.showBanner"
        :class="{ 'fixed': $route.name === 'OutputEpisodeDrafts' }"
        :hide-countdown="$route.name === 'OutputEpisodeDrafts'"
      />
      <router-view />
    </q-page-container>
    <q-dialog
    ...
    >
      <AppCard>
        <template #body>
          <div class="text-center lexend-deca-regular letter-spacing-1 q-gutter-y-md">
            ...
            <q-btn
              v-close-popup
              class="border-radius-10 lexend-deca-medium"
              color="accent"
