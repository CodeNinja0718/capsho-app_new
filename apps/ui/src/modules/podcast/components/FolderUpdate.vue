...
const step = ref<'updatefolder' | 'voicetone' | 'socials' | ''>('')
...
<template>
  ...
  >
    <div class="rounded-[50px] w-full p-4 md:p-6 lg:p-10 xl:p-14 bg-dialog-dark border-accent border-4 border-solid">
      <h3 class="lexend-regular">Edit folder</h3>
          ...
          <div id="podcastCover">
            <DropZone @files-dropped="addImages">
              <template #default="{ dropZoneActive }">
                ...
                >
                  <div class="text-center border-accent border-4 border-solid rounded-full">
                    <q-avatar
  ...
  >
    <div class="rounded-[50px] w-full p-4 md:p-6 lg:p-10 xl:p-14 bg-dialog-dark border-accent border-4 border-solid">
      ...
      <q-form class="w-full grid grid-cols-12 gap-y-6">
        ...
        >
          <div
            class="w-20 h-20 flex justify-center items-center border-accent border-4 border-solid rounded-[25px] cursor-pointer"
