    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: 'sign-in',
            name: 'AuthSignIn',
            component: () => import(/* webpackChunkName: "AuthSignIn" */ 'src/modules/auth/components/desktop/DesktopSignInCard.vue'),
            meta: {
              guestOnly: true,
              hideQuate: true
            }
          },
          {
            path: 'sign-up',
            name: 'AuthSignUp',
            component: () => import(/* webpackChunkName: "AuthSignUp" */ 'src/modules/auth/components/desktop/DesktopSignUpEmailPasswordCard.vue'),
            meta: {
              guestOnly: true,
              hideQuate: false
            }
      ...
      {
        path: 'guest/sign-up',
        name: 'AuthSignUpGuest',
        component: () => import(/* webpackChunkName: "AuthSignUpGuest" */ 'src/modules/auth/pages/SalesSignUp.vue'),
        meta: {
          guestOnly: true
        }
      },
