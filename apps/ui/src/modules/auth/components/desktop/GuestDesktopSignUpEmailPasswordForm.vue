  ...
  >
    ...
    >
      <q-btn
        ...
        type="submit"
      />
      <div class="hidden full-width row justify-center items-center py-4">
        <span>I'm already a Capsho User.</span>
        <q-btn
          class="underline q-px-xs underline-offset-2"
          color="accent"
          flat
          label="Sign in"
          no-caps
      ...
      <p class="text-center text-13">
        Please note: If you are already a Capsho Host, create a new Capsho
        Guest account with a different email address.
      </p>
    </div>
    <div
      v-else
