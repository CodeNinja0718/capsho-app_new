<template>
  <div class="q-px-xl q-pb-xl pricing-page">
    <h1 class="lexend-medium text-25 text-center custom-dark-blue">Plans And Pricing</h1>
      ...
      <template v-slot:header="props">
        <q-tr :props="props">
          <q-th
            ...
            :key="col.name"
            class="lexend-medium text-accent"
            :props="props"
          ...
          <q-td
            ...
            <span v-else-if="typeof props.row.starter === 'object'">
              ...
              <span
                ...
                <span class="lexend-medium text-16">{{ props.row.starter.additionalEpisodePrice }}</span>
              ...
              >
                <span class="row items-center justify-center">
                  <span class="lexend-medium text-20">{{ props.row.starter.price }}</span>
                  <span
                    v-if="annual"
                ...
                <span
                  v-if="annual"
                  class="lexend-medium text-accent block q-pb-sm"
                >
                  {{ 'SAVE ' + props.row.starter.save }}
                </span>
                <span>
                  <q-btn
                    class="border-radius-10 lexend-regular"
                    color="accent"
                    label="Get started now"
                    no-caps
                    padding="10px 22px"
                    text-color="white"
                    @click="subscribe(props.row.starter.priceId)"
                  />
                </span>
              </span>
            </span>
          ...
          <q-td
            ...
            <span v-else-if="typeof props.row.growth === 'object'">
              ...
              <span
                ...
                class="row items-center justify-center">
                <span class="lexend-medium text-16">{{ props.row.growth.additionalEpisodePrice }}</span>
                <span class="inter-light"> / episode</span>
              </span>
              ...
              >
                <span class="row items-center justify-center ">
                  <span class="lexend-medium text-20">{{ props.row.growth.price }}</span>
                  <span
                    v-if="annual"
                    class="inter-light"> / yearly</span>
                  <span
                ...
                <span>
                  <q-btn
                    ...
                    text-color="white"
                    unelevated
                    @click="subscribe(props.row.growth.priceId)"
                  />
                </span>
              </span>
            </span>
          ...
          <q-td
            ...
            <span v-else-if="typeof props.row.pro === 'object'">
              ...
              <span
                ...
                class="row items-center justify-center">
                <span class="lexend-medium text-16">{{ props.row.pro.additionalEpisodePrice }}</span>
                <span class="inter-light"> / episode</span>
              </span>
              ...
              >
                <span class="row items-center justify-center ">
                  <span class="lexend-medium text-20 q-gutter-x-xs"
                  >
                    <span :class="{ 'text-strike': !annual }">{{ props.row.pro.price }}</span>
                    <span v-if="!annual">$13.50</span>
                  </span>
                  <span
                    v-if="annual"
                    class="inter-light"> / yearly</span>
                ...
                <span>
                  <q-btn
                    ...
                    text-color="white"
                    unelevated
                    @click="subscribe(props.row.pro.priceId)"
                  />
                  <q-btn
                    v-else
                    class="border-radius-10 lexend-regular"
                    ...
                    text-color="white"
                    unelevated
                    @click="createCheckoutOfferSession"
                  />
                </span>
              </span>
            </span>
          ...
          <q-td
            ...
            <span v-else-if="typeof props.row.agency === 'object'">
              ...
              <span
                ...
                class="row items-center justify-center">
                <span class="lexend-medium text-16">{{ props.row.agency.additionalEpisodePrice }}</span>
              </span>
              ...
              >
                <span class="invisible row items-center justify-center ">
                  <span class="lexend-medium text-20">{{ props.row.agency.price }}</span>
                  <span
                    v-if="annual"
                    class="inter-light"> / yearly</span>
                  <span
                ...
                <span
                  v-if="annual"
                  class="invisible lexend-medium text-center text-accent block q-pb-sm"
                >
                  {{ 'SAVE ' + props.row.agency.save }}
                </span>
                <span>
                  <a
                    class="q-btn q-btn--no-uppercase cursor-pointer btn-grey border-radius-10 text-white lexend-regular"
...
const proPlanPriceIds = getProProductPriceIds()

const authStore = useAuthStore()
async function createCheckoutOfferSession () {
  $q.loading.show({
    delay: 400
  })
  try {
    const priceId = proPlanPriceIds.monthly
    ...
    const response = await authStore
      ...
      .createCheckoutSessionV2({
        ...
        couponId,
        redirectUrl,
        customerId: authStore.user.stripeId
      })
