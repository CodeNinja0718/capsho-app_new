...
<template>
  <div class="q-px-xl q-pb-xl pricing-page">
    <h1 class="lexend-medium text-25 text-center text-text">Plans And Pricing</h1>
    ...
    <q-table
      ...
      class="pricing-table text-grey-3 inter-regular bg-transparent"
      :columns="columnsV2"
      flat
      hide-bottom
      row-key="name"
      ...
      <template v-slot:header="props">
        <q-tr :props="props">
          <q-th
            ...
            :key="col.name"
            class="lexend-medium text-accent-custom"
            :props="props"
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td
            key="name"
            class="text-text"
            :class="{ 'inter-bold text-uppercase text-accent-custom text-25 letter-spacing-1': props.row.bold }"
            :props="props"
          >
            {{ props.row.name }}
            <div
              v-if="props.row.info"
              class="text-10 text-text"
          ...
          <q-td
            ...
            <span v-else-if="typeof props.row.pro === 'object'">
              ...
              >
                <span class="row items-center justify-center ">
                  <span class="lexend-medium text-20">{{ props.row.pro.price }}</span>
                  <span
                    v-if="annual"
                    class="inter-light"> / yearly</span>
                  <span
    ...
    <AppCard>
      <template #body>
        <div class="column items-center q-col-gutter-y-md">
          ...
          <div class="col-auto q-gutter-x-lg lexend-regular">
            <q-btn
              v-close-popup
              flat
              label="Cancel"
