...
const referralLink = computed(() => authStore.referralLink)
...
<template>
  <q-page>
    ...
    >
      <h1 class="poppins-semibold text-h5 text-center"
      >
        Referrals
      </h1>
      <div
        ...
        class="q-px-xl pt-0"
      >
        <div class="row justify-center q-gutter-x-xl no-wrap py-2"
        >
          <q-card
            class="billing-card q-pa-md bg-background-any-box-popup text-text shadow-lg"
            flat
          >
            <h6 class="w-full text-center">Referrals</h6>
            <p class="w-full text-center">Your link</p>
            <div class="px-3 py-2">
              <div class="w-full px-3 py-2 bg-accent-custom text-white rounded-full flex justify-between items-center">
                <span>{{ referralLink || 'Not set' }}</span>
                <q-btn
                  flat
                  icon="content_copy"
                  round
      ...
      >
        ...
        >
          <q-card
            class="billing-card q-pa-md bg-background-any-box-popup text-text"
            flat
          >
            <div>
              ...
              <div class="text-center text-12">
                ...
                <span class="poppins-semibold">{{ additionalCredits }}</span>
              </div>
              <div class="poppins-semibold text-center text-10 q-py-sm">
          ...
          >
            <div class="column justify-between items-center full-height">
              <div class="col-3 text-body2 text-capitalize">
                Current Plan <b>{{ subscription.status }}</b>
              </div>
              <div class="col-auto text-uppercase lexend-bold text-14">
          ...
          >
            <div class="q-col-gutter-y-sm column justify-center items-center full-height">
              <div>
                <div class="text-subtitle1 poppins-medium text-center">
                  Subscribed
                </div>
                <div class="text-accent-custom text-body2 poppins-medium text-center">
            ...
            >
              <q-item-section>
                <div class="row items-center q-gutter-x-xl">
                  <div>
                    <a
                      class="q-pr-xs text-accent-custom"
