...
const tabs = ref([
	{ name: 'Get Podcast', isSelected: true, color: 'primaryDark', weight: 'bold' },
	{ name: 'Upload Podcast', isSelected: false, color: 'gray-800', weight: 'normal' },
	{ name: 'Saved Podcasts', isSelected: false, color: 'gray-800', weight: 'normal' },
	{ name: 'Submit For Transcription', isSelected: false, color: 'gray-800', weight: 'normal' }
])

const tabIndex = ref(0)

export function useTogglePodcastMenu() {
